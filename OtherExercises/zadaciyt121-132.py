...
for i in range(len(a)):
    print(a[i])  #ispisue elementite na listata edin ispod drug
a=[3,7,15,6,2,4]
for i in range(0,len(a),2):
     print(a[i])  #stampa prez edin (3,15,2)
...
a=[3,7,15,6,2,4]
for el  in a:
    print(el)   #stampa site elementi edin ispod drug

a=[3,7,15,6,2,4]
for el in a:
    if el%2==1:
        print(el) #stampa samo neparnite - 3,7,15

a=[3,7,15,6,2,4]
for el in a:
    if el%2==0:
        print(el) #stampa samo parnite - 6,2,4
...
for el in a:
    if el%2==1:
        neparni=neparni+[el]
print(neparni) #[3,7,15]
print(sum(neparni)/len(neparni))  #printira aritmeticka sredina na neparnite
...
for el in a:
    if el%2==1:
        neparni=neparni+[el]
print(neparni) #[3,7,15]
print("{:.2f}".format(sum(neparni)/len(neparni))) #da zaokruzi na 2 decimali rezultato
...
print(a.count(3)) #kolko puti taj element u zagradite imame u listata
a.insert(2,44)
print(a) #na 2 pozicija pise 44 umesto 5, a 5 ide na 3 pozicija
print(a.index(3)) #na koja pozicija se naodi elemento u zagradata
print(a.index(5)) #2
print(a.index(75)) #4
a.sort()
print(a) #printira elementite od najmalecak do najgolem
a.reverse()
print(a) #printira elementite od najgolem do najmalecak
...
a.pop()
print(a) #uklanja poslednjio element
a.pop(1)
print(a) #uklanja elemento na pozicija u zagradata
del a[2]
print(a) #brise element na pozicija 2
del a[:]
print(a) #brise celata lista
...
# #print(lista) #2 4 5 7 8    #stampa 4 i 7 jer sa na parna pozicija
...
#     cifre[c]=cifre[c]+1   #uvecavamo pojavljivanje cifre c
...
#     n=n//10    #ponistavamo poslednju cifru broja n
# for a in range(10):
