...
import math
n = int(input("Unesite broj: "))
rez = round(math.sqrt(n))**2   #zaokruzi taj kvadratni koren i opet ga kvadriraj nezaokruzenog
...
s1, m1, se1 = map(int, input("Unesite stepene, minute i sekunde 1. ugla ").split())
s2, m2, se2 = map(int, input("Unesite stepene, minute i sekunde 2. ugla ").split())
