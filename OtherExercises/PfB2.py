...
# except ValueError:
#     print('Invalid value')
#ako unesem 20 printira 20, ako unesem asd printira Invalid value (primer)
...
#ako unesem 1,2,3,..,n printira taj broj
#ako unesem 0 printira Age cannot be 0.
#ako unesem tekst printira Invalid value.
