...
vavezdate stoinosti za stranite na figurata.'''
...
'''3.Napisete programa, koqto namira srednoaritmeticnoto
na cislata, koito se delqt na 3 v intervala ot 7 do 70.'''
...
'''4.Napisete programa, koqto po vavedeno ot potrebitelq cislo opredelq:
...
# if ((n%100)//10)%2==0:
#     print("Cifrata na deseticite e cetno cislo")
# else:
#     print("Cifrata na deseticite ne e cetno cislo")    

'''5.Napisete programa, koqto po zadaden broj dni(n)
izvezda koj den ot sedmicata shte b'de.Dnesniqt den
i broqt na dnite se vavezdat ot potrebitelq.Da se
izvede na ekrana n-tiq den sled dnesniq koj den
ot sedmicata e.Broeneto na dnite zapocva ot edno t.e.
