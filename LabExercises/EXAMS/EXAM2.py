'''Да се състави програма на Python, която дефинира клас "GSM mobile devices", с полета: 
налично количество, единична цена, година на производство, производител, модел на мобилни устройства. 
Да се състави: 
