#1.Napishete programa koqto namira liceto na geometrichna figura
#kato purvo se vavejda vida na figurata. S opciqta 1 da se izbira
...
figure = int(input("Izberete nomera na figurata[1-5]: "))
