...
print(course[0]) #P
print(course[6]) #empty line (space)
print(course[3]) #h
print(course[10]) #empty line (space)
...
''' 1.Price of a house is #1M. If buyer has good credit, the need to put down 10%. Otherwise they need to put down 20%. Print the down payment.'''
...
while i<=5:
    print(i)
    i=i+1 
print("Done")    #1 2 3 4 5 Done (one bellow the other)
...
for item in 'Python':
    print(item)  #Python one bellow the other

for item in ['Stefan','Mike']:
    print(item) #Stefan Mike one bellow the other

for item in [1,2,3,4,5]:
    print(item) #1 2 3 4 5 one bellow the other
...
for row in matrix:
    for item in row:
        print(item)    #1 2 3...9 one bellow the other
