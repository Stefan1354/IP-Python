...
while n<=100:         #radi sve dok je n<=100
     suma+=n          #dodajemo na sumu broj n
     print(n, suma)
     n+=2
print("Suma je: ", suma)
...
while a<=N:
     suma+=a   #Dodajemo na sumu
     print("Dodajem ",a," i suma do sada je ",suma)
     a+=1          #Uvecavamo a za 1
print("Suma je ",suma)
...
suma = 0
while N>=1:
     suma+=N       #Dodajemo N na zbir
     N-=1          #Smanjujemo N za 1
print("Suma je", suma)
...
while a<=n:     #radi sve dok je a<=n, dok ne unesemo n brojeva
     ...
     if br>Najv:
          Najv=br
     a+=1    #Uvecavamo a za sledecu iteraciju
